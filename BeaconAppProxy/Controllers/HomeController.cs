    ...
    public class HomeController : Controller {
        ...
        public ActionResult Beacons() {
            ...
            beacons.Add(new Beacon {
                ...
                Minor = "38039",
                ClassRoom = "HAA-H1-21",
                ImageUrl = "https://beacon-app-proxy.azurewebsites.net/Content/photo1.jpg"
            });
            beacons.Add(new Beacon {
                Major = "37461",
                Minor = "17643",
                ClassRoom = "HAA-H1-23",
                ImageUrl = "https://beacon-app-proxy.azurewebsites.net/Content/photo2.jpg"
            });
            beacons.Add(new Beacon {
                Major = "29417",
                Minor = "46117",
                ClassRoom = "HAA-H1-14",
                ImageUrl = "https://beacon-app-proxy.azurewebsites.net/Content/photo3.jpg"
            });
